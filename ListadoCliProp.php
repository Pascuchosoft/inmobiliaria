...
<h1>Listado de Clientes Propietrios</h1>
<hr />
<br />
<?php
...
if ($buff == 2 || $buff == 1){
	$idCone = conectarBD();
	$SQL="Select u.Nombre , u.Apellido, u.CI, p.nomperfil, u.idUsu, u.fech_nac, u.dir, u.tel, u.email, cp.idCli
		  From usuarios u, perfiles p, cli_prop cp
		  Where p.IdPerfil=u.IdPerfil and u.idUsu = cp.IdCli and u.idPerfil = '3' order by u.Nombre";
	...
	echo "<tr><th>id<th>Nombre<th>Apellido<th>C.I.<th>Perfil<th>fech_nac<th>Dirección<th>Tel<th>e-mail<th></tr>";
	while ($row=mysqli_fetch_array($rs)){
		$usu = $row['idUsu'];
		$contador = $contador + 1;
		echo "<tr>";
		echo "<td align=Center bgcolor='#eeeeee' font color='#dddddd'>".$row['idUsu']."</td>";
		...
		echo "<td align=Center bgcolor='#eeeeee' font color='#dddddd'>".$row['nomperfil']."</td>";
		echo "<td align=Center bgcolor='#eeeeee' font color='#dddddd'>".$row['fech_nac']."</td>";
		...
		echo "<td align=Center bgcolor='#eeeeee' font color='#dddddd'><a href='IModificaUsu.php?modo=2&usuario=$usu'>Modificar</a></td>";
		echo "<td align=Center bgcolor='#eeeeee' font color='#dddddd'><a href='IBajaUsu.php?modo=3&usuario=$usu'>Eliminar</a></tr>";
		}
		echo "</table>";
}else{
...
<form name="frm" method="post" action="ListadoCliProp.php" >
<br />
