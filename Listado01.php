...
if ($buff == 2 || $buff == 1){
	$idCone = conectarBD();
	$SQL="Select u.Nombre , u.Apellido, u.CI, p.nomperfil, u.idUsu, u.fech_nac, u.dir, u.tel, u.email
		  From usuarios u, perfiles p
		  Where p.IdPerfil=u.IdPerfil order by u.Apellido , u.Nombre ";
	...
	echo "<tr><th>id<th>Nombre<th>Apellido<th>CI<th>Perfil<th>fech_nac<th>Dirección<th>Tel<th>e-mail<th><th></tr>";
...
<form name="frm" method="post" action="Listado01.php" >
<br />
