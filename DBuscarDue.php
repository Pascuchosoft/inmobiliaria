...
$apedue= $_POST['txt_apedue'];

$SQL = "select nombre, apellido, dir, tel, idDue, email, CI
		from duenio
		where apellido = '$apedue' order by apellido";
...
if($_POST['txt_ci']!=''){
	...
	$SQL = "select nombre, apellido, dir, tel, idDue, email, CI
			from duenio
			where CI = '$ci' and apellido = '$apedue' order by apellido";
		if($_POST['txt_nomdue']!=''){
			$nomdue = $_POST['txt_nomdue'];
			$SQL = "select nombre, apellido, dir, tel, idDue, email, CI
					from duenio
					where CI = '$ci' and apellido = '$apedue' and nombre = '$nomdue' order by apellido";
		}
}
