...
if($perfil == 1 || $perfil == 2){
	...
	$Registro = mysqli_query($idCone,$SQL_1);
		...
		while($Fila = mysqli_fetch_array($Registro)){
			$dir = $Fila['dir'];
			$idProp = $Fila['idProp'];
			$Prop = new Propiedad($idProp, $dir, $Fila['tipo'], $Fila['barrio'], $Fila['operacion'], $Fila['precio'], "", "");
			echo "<Tr>";
...
?><Td align=Center bgcolor="#eeeeee" font color="#dddddd"><img width="50" height="50" src="imagenes_prop/<?php echo $idProp ?>.jpg" onclick="open_popup('popup_imagen_casa.php?idProp=<?php echo $idProp ?>','win2')"  /><?php
			echo "<Td align=Center bgcolor='#eeeeee' font color='#dddddd'>" . "<a href='muestroDetalles.php?buff=$dir&pag=$pag_actu&idProp=$idProp&modo=1'>Ver</a>";
			...
			echo "<Td align=Center bgcolor='#eeeeee' font color='#dddddd'>" . "<a href='visitas.php?idCli=$idUsu&idProp=$idProp&pag=$pag_actu'>visitar</a>";
			echo "<Td align=Center bgcolor='#eeeeee' font color='#dddddd'>" . "<a href='subeArchivo.php?modo=2&idProp=$idProp&pag=$pag_actu'>subir imag</a>";
	...
	$Registro = mysqli_query($idCone,$SQL_1);
		...
		while($Fila = mysqli_fetch_array($Registro)){
			...
			echo "<Td align=Center bgcolor='#eeeeee' font color='#dddddd'>" . $Fila['apellido'];
?><Td align=Center bgcolor="#eeeeee" font color="#dddddd"><img width="50" height="50" src="imagenes_prop/<?php echo $idProp ?>.jpg" onclick="open_popup('popup_imagen_casa.php?idProp=<?php echo $idProp ?>','win2')"  /><?php
			echo "<Td align=Center bgcolor='#eeeeee' font color='#dddddd'>" . "<a href='muestroDetalles.php?buff=$dir&pag=$pag_actu&idProp=$idProp'>Ver</a>";
			echo "<Td align=Center bgcolor='#eeeeee' font color='#dddddd'>" . "<a href='visitas.php?idCli=$idUsu&idProp=$idProp&pag=$pag_actu'>visitar</a>";
			echo "<Tr>";
		} 
		 echo "</table>";	
...
<form name="frm" method="post" action="paginado.php" >
<br />
